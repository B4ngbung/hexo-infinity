...
function bsPaginatorHelper(options){
  ...
  var currentPage = '<li class="active page-item"><span class="page-number page-link">' +
  ...
  function pageLink(i){
    return '<li class="page-item"><a class="page-number page-link" href="' + link(i) + '">' +
  ...
  if (prevNext){
    if (current > 1) {
      result += '<li class="page-item"><a class="page-prev page-link" rel="prev" ' +
              'href="' + link(current - 1) + '">' + prevText + '</a></li>';
    } else {
      result += '<li class="disabled page-item"><span class="page-prev page-link">' + prevText + '</a></li>';
    }
  }
  ...
  if (options.show_all){
    ...
    var spaceHtml = '<li class="disabled page-item"><span class="page-space page-link">' + space + '</span></li>';
  ...
  if (prevNext){
    if (current < total) {
      result += '<li class="page-item"><a class="page-next page-link" rel="next" ' +
              'href="' + link(current + 1) + '">' + nextText + '</a></li>';
    } else {
      result += '<li class="disabled page-item"><span class="page-next page-link">' + nextText + '</a></li>';
    }
  }

  return '<nav><ul class="pagination justify-content-center">' + result + '</ul></nav>';
}
